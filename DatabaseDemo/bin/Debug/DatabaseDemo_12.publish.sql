...
GO
PRINT N'The following operation was generated from a refactoring log file b154594b-d6f2-49d9-893e-ebb1fbd2089d';

PRINT N'Rename [dbo].[tblChallenge].[IsChallengeComfirmed] to IsChallengeConfirmed';


GO
EXECUTE sp_rename @objname = N'[dbo].[tblChallenge].[IsChallengeComfirmed]', @newname = N'IsChallengeConfirmed', @objtype = N'COLUMN';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'b154594b-d6f2-49d9-893e-ebb1fbd2089d')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('b154594b-d6f2-49d9-893e-ebb1fbd2089d')
